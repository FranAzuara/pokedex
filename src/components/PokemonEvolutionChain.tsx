...
const PokemonEvolutionChain: React.FC<PokemonEvolutionChainProps> = ({ evolutions }) => {
  return (
    <div className="flex justify-center px-4 sm:px-8 md:px-16 lg:px-24 xl:px-40 py-5">
      <div className="layout-content-container flex flex-col max-w-[960px] flex-1">
        <h2 className="text-2xl font-bold text-gray-900 dark:text-white px-4 mb-8 text-center md:text-left">Evolution Chain</h2>
              ...
              {index < evolutions.length - 1 && (
                <div className="flex flex-col items-center gap-2">
                   <div className="hidden md:block">
                    <span className="material-symbols-outlined text-gray-400 text-4xl">arrow_forward</span>
                   </div>
                   <div className="md:hidden">
                    <span className="material-symbols-outlined text-gray-400 text-4xl rotate-90">arrow_forward</span>
                   </div>
                   {step.level && (
                     <span className="text-xs font-bold text-red-500 uppercase tracking-widest">Level {step.level}</span>
                   )}
                </div>
              )}
            </React.Fragment>
