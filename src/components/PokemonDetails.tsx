...
const PokemonDetails: React.FC<PokemonDetailsProps> = ({ height, weight, abilities, hiddenAbility, stats }) => {
  return (
    <div className="flex justify-center px-4 sm:px-8 md:px-16 lg:px-24 xl:px-40 py-5">
      <div className="layout-content-container flex flex-col max-w-[960px] flex-1 bg-white dark:bg-gray-900 rounded-3xl p-8 shadow-sm">
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="flex justify-between py-2 border-b border-gray-100 dark:border-gray-800">
                ...
                <span className="text-gray-900 dark:text-white font-bold">{height}</span>
              </div>
              <div className="flex justify-between py-2 border-b border-gray-100 dark:border-gray-800">
                <span className="text-gray-500 dark:text-gray-400 font-medium">Weight</span>
                <span className="text-gray-900 dark:text-white font-bold">{weight}</span>
              </div>
              <div className="flex justify-between py-2 border-b border-gray-100 dark:border-gray-800">
            ...
            <div className="space-y-4">
              {stats.map((stat) => (
                <div key={stat.name} className="flex items-center gap-4">
                  <span className="w-16 text-xs font-bold text-gray-500 dark:text-gray-400 uppercase">{stat.name}</span>
                  <span className="w-8 text-sm font-black text-gray-900 dark:text-white">{stat.value}</span>
