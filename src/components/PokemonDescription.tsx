  ...
  return (
    <div className="flex justify-center px-4 sm:px-8 md:px-16 lg:px-24 xl:px-40 py-5">
      <div className="layout-content-container flex flex-col max-w-[960px] flex-1">
        <div className="flex flex-col md:flex-row gap-6 bg-[#9bcc50] rounded-3xl overflow-hidden min-h-[400px]">
          <div className="flex-1 p-8 md:p-12 flex flex-col justify-center text-white">
            <h1 className="text-4xl md:text-6xl font-black leading-tight tracking-[-0.015em]">
